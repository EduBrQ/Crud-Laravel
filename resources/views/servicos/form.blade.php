...
@section('content')
    ...
    <div class="header">
        <div class="page-header page-header-default">
            ...
            <div class="page-header-content">
                <div class="page-title">
                    <h4>
                        ...
                        {{isset($servicos) ? $bread = 'Atualização de Servicos' : $bread = 'Cadastro de Servicos' }}
                    </h4>
                </div>
            </div>
            <hr>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/servicos">Servicos</a></li>
    ...
    <!-- Form horizontal -->
    @if(isset($servicos))
        {{ Form::model($servicos, array('route' => array('servicos.update', $servicos->id),
            ...
            <div class="panel panel-flat">
                <div class="panel-body">
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-primary">{{isset($servicos) ? 'Atualizar' : 'Cadastrar' }}
                            <i
